...
> **Sample on GitHub** · `AUS200_1m.csv` (55,440 rows, `2026-07-01` -> `2026-09-02`, 3.52 MB). **Full archive on [getdata.finance](https://getdata.finance/datasets/aus200)** — **5,275,014** `1m` rows (full `1m`: 5,275,014), **11 timeframes**, `2008-09-10` -> `2026-09-02`.
